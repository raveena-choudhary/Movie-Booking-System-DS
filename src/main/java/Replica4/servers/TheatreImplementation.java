...
import Replica4.movieTicketBookingSystem.booking.Booking;
import Replica4.utils.UDPSendRecieve;
...
import static utils.Utils.getLocalDateObFromMovieID;
...
//        res = isNewSlot ? "Movie slot added successfully!" : "Movie slot updated successfully!";
    ...
    public synchronized void findNextAvailableSlotAndReturnSlot(String customerID, String movieName, String movieID, int oldTicketCount) {
        ...
        Collections.sort(listOfMovieID, (o1, o2) -> {
            ...
            LocalDate movieTime1 = getLocalDateObFromMovieID(o1);

            LocalDate movieTime2 = getLocalDateObFromMovieID(o2);
